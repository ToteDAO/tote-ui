                ...
                <div className={classes.heroContent}>
                    <Container maxWidth="sm">
                        <Typography component="h1" variant="h2" align="center" color="textPrimary" gutterBottom>
                            Join a bounty of choice
                        </Typography>
                        <Typography variant="h5" align="center" color="textSecondary" paragraph>
                           Join any bounty of interest, get verified, add genuine reviews and get paid
                        </Typography>
                            ...
                            <Grid item key="1" xs={12} sm={6} md={4}>
                                <Card className={classes.card}>
                                    ...
                                    <CardContent className={classes.cardContent}>
                                        ...
                                        <Typography>
                                            Apple would love to know if you love their new dual camera system
                                        </Typography>
                                    </CardContent>
                                    <CardActions>
                                        {redirectToAddReview && <Redirect to="/addreview/1"/>}
                            ...
                            <Grid item key="2" xs={12} sm={6} md={4}>
                                <Card className={classes.card}>
                                    ...
                                    <CardContent className={classes.cardContent}>
                                        ...
                                        <Typography>
                                            Lipton would love to know if you enjoy your tea 
                                        </Typography>
                                    </CardContent>
                                    <CardActions>
                                    {redirectToAddReview && <Redirect to="/addreview/2"/>}
                                        <Button size="small" color="primary" onClick={() => setredirectToAddReview(true)}>
                                        Add Review
                                        </Button>
                                    </CardActions>
                            ...
                            <Grid item key="3" xs={12} sm={6} md={4}>
                                <Card className={classes.card}>
                                    ...
                                    <CardContent className={classes.cardContent}>
                                        ...
                                        <Typography>
                                            Devfolio would love to know your opinion on the hacker leaderboard
                                        </Typography>
                                    </CardContent>
                                    <CardActions>
                                    {redirectToAddReview && <Redirect to="/addreview/3"/>}
                                        <Button size="small" color="primary" onClick={() => setredirectToAddReview(true)}>
                                        Add Review
                                        </Button>
                                    </CardActions>
